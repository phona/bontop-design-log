...
5. **客餐厅人字拼**：floor_tile_herringbone_01 已建模可 3D A/B。~~双门槛：3D 走查心动 + 门店四问~~ **3D 关未过**（2026-08-12：日/夜两轮走查"不惊艳"，直铺夜景"很舒服"）。降级为门店样板终审项：样板不惊艳则正式放弃（+6~10k 省下），法式骨架由 PU 线条+灯光+柜门承担。
