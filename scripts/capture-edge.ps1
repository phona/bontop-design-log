# Capture floor plan screenshot from Edge
...
Write-Host "Page.enable response received"
...
$dataUrl | Out-File -FilePath $outputPath -Encoding UTF8 -NoNewline
Write-Host "Data URL saved to $outputPath"
Write-Host "Length: $($dataUrl.Length) characters"
