...
vi.mock('./data/designData.js', () => ({
  ...
  sanitaryOptions: [],
  interiorDoorOptions: [],
  materialCategories: { floor: [], bedroom_floor: [], wall: [], paint: [], cabinet: [], countertop: [], sanitary: [], door: [] },
  getMaterialOptions: () => ({ floor: [], bedroom_floor: [], wall: [], paint: [], cabinet: [], countertop: [], sanitary: [], door: [] }),
}));
